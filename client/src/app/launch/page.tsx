    ...
    return (
        ...
        <main className="twitter">
            ...
            <div className="twitter__middle mt-2">
                <div className="flex gap-x-4">
                    <div className="flex flex-wrap gap-4 p-4 w-[80%]">
                        {[
                            ...
                            >
                                <input className="peer hidden" type="radio" name="category" id={category.id} />
                                <label
                                ...
                                <span className="pointer-events-none z-10 text-xs">{category.label}</span>
                            </div>
                        ))}
                    </div>
                    <div className="w-[20%] mt-8">
                        <button className="twitter-nav__item active" onClick={()=>alert("Hello World !!!")}>
                            <svg
                                viewBox="0 0 24 24"
                                className="r-13gxpu9 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
                            >
                ...
                <div className="twitter-feed grid grid-cols-2 gap-6 mt-10" data-aos="fade-up">
                    {postData.map((item, i) => {
                        return <>
